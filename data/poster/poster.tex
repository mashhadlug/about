...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=center, rotate=-40] at (-0.2\paperwidth,0.1\paperheight)
    {\includegraphics[width=0.50\paperwidth]{assets/session1.jpg}};

  \node[anchor=center, rotate=8] at (-0.3\paperwidth,-0.32\paperheight)
    {\includegraphics[width=0.40\paperwidth]{assets/session2.jpg}};

  \node[anchor=center, rotate=40] at (-0.17\paperwidth,-0.75\paperheight)
